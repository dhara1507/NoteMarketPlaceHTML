    ...
    <div class="header header-note">
        ...
        <div class="header-right header-note-detail">
            <ul class="nav nav2 navbar-nav pull-right">
                <li><a href="../User(back_end)/search.php">Search Note</a></li>
                <li><a href="../User(back_end)/dashboard.php">Sell Your Notes</a></li>
                <li><a href="../User(back_end)/buyerreq.php">Buyer Requests</a></li>
                <li><a href="../User(back_end)/faq.html">FAQ</a></li>
                    ...
                    $img='';
                       ...
                       ?>
                        <div class="dropdown-content dash-content" style="height:250px;">
                            ...
                            <a href="../User(back_end)/myreject.php">My Rejected Notes</a>
                            <a href="../User(back_end)/cp.php">Change Password</a>
                            <a href="../User(back_end)/logout.php" class="logout">LOGOUT</a>
                        </div>
                    </div>
                </li>
               
                <li>
                    <form action="login.php"><input type="submit" class="btn2 btn2-user" value="Logout"></form>
                </li>
            </ul>
        </div>
        <!--Mobile Menu-->
