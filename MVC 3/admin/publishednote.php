...
-->
    ...
    <section id="managed">
        <div class="managed-admin down-dash">
            <h1 class="manage-heading manage-ad">Published Notes</h1>
            ...
            <select id="seller" onchange="dash2()" class="custom-select-01 form-control user admin-select form-group-left option-notes">
                <option value=''>SELLER</option>
                                    <?php
                                    $query="SELECT distinct users.FirstName,users.LastName FROM sellernotes LEFT JOIN users ON sellernotes.SellerID=users.ID WHERE Status='4'";
            ...
            <div class="search-container manage-search down-container">
                <form method="post">
                        <input type="text" id="searchtext" onkeyup="dash2()" class="dash-search user" placeholder="      Search..">
