...
<body>
    ...
    while($row=mysqli_fetch_assoc($result)){
        ...
        echo "<div class='col-md-6 col-sm-6'>
                ...
                <div class='col-md-6 col-sm-6 col-xs-6'>
                    <div class='note1 note1-r d-flex flex-wrap'>
    ...
    if(isset($_POST['download'])){
        ...
        if($type=='1'){
            ...
            $query="INSERT INTO downloads(ID,NoteID,Seller,Downloader,IsSellerHasAllowedDownload,AttachementPath,IsAttachmentDownloaded,AttachmentDownlodedDate,IsPaid,PurchasedPrice,NoteTitle,NoteCategory,CreatedDate,CreatedBy,ModifiedDate,ModifiedBy,IsActive ) VALUES('','{$id}','{$id1}','119','1','','1','','1','{$price}','{$title}','{$category}','','','','','')";
            $result=mysqli_query($conn,$query);
            print_r($result);
            if(!$result){
    ...
    <section id="note-details">
        <div class="note">
            <div class="row">
                <div class="col-md-6">
                    <div class="note1-left">
                        <div class="col-md-6">
                            <h1 class="note-heading notes-pre">Notes Preview</h1>
                            <div class="note-left-1">
                                <img src="images/Front_images/images/sample-pdf.png" class="sample-img">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!--Thanks Popup-->
    <div class="modal fade" style='height:2000px' id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
